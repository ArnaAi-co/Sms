...
use function App\Http\Controllers\Auth\toastr;
...
class RegisteredUserController extends Controller
{
    ...
    public function create()
    {
        if (auth()->user()) {
            ...
            if (config('settings.subscribe') == 'disabled') {
                return view('auth.register', compact('information', 'extension'));
            } else {

                return view('auth.subscribe-one', compact('information', 'extension'));
            }
        }
    }
    ...
    public function stepTwo(Request $request)
    {
        ...
        return view('auth.subscribe-two', compact('extension', 'monthly', 'yearly', 'lifetime', 'monthly_subscriptions', 'yearly_subscriptions', 'lifetime_subscriptions'));
    }
    ...
    public function stepThree(Request $request)
    {
        ...
        return view('auth.subscribe-three', compact('extension', 'id', 'payment_platforms', 'tax_value', 'total_value', 'currency', 'gateway_plan_id', 'bank', 'bank_order_id'));
    }
